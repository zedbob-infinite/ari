...
vmmake: main.c object.o objstack.o interpret.o instruct.o repl.o vm.o compiler.o tokenizer.o parser.o memory.o
	$(CC) $(CFLAGS) $(INC) instruct.o interpret.o tokenizer.o objstack.o compiler.o repl.o object.o vm.o parser.o memory.o main.c -o ari
